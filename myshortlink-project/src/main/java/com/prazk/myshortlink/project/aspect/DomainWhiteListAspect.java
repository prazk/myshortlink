package com.prazk.myshortlink.project.aspect;
...
public class DomainWhiteListAspect {
    @Pointcut("execution(* com.prazk.myshortlink.project.service.*.* (..)) && @annotation(com.prazk.myshortlink.project.annotation.DomainWhiteList)")
    ...
    public void domainWhiteList(ProceedingJoinPoint joinPoint) throws Throwable {
        if (!whiteListEnabled) {
            joinPoint.proceed();
        }
